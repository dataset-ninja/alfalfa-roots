...
##################################
PROJECT_NAME: str = "Alfalfa Roots"
PROJECT_NAME_FULL: str = "Alfalfa Roots: Data for Manuscript on Objective Phenotyping of Alfalfa Roots"
...
RELEASE_DATE: Optional[str] = "2022-01-19"  # e.g. "YYYY-MM-DD"
if RELEASE_DATE is None:
    RELEASE_YEAR: int = None

HOMEPAGE_URL: str = "https://zenodo.org/record/5879779#.YlFF6X9Bzmg"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 6749443
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/alfalfa-roots"
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9012978/"
